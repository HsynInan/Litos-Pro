import 'package:onikincisinif12_soruvedersnotlari/lib/screns/DokuzSoru/DokuzSoruDetayPage.dart';
...
class DokuzSoru extends StatefulWidget {
  DokuzSoru({Key key}) : super(key: key);

  @override
  _DokuzSoruState createState() => _DokuzSoruState();
}

class _DokuzSoruState extends State<DokuzSoru> {
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (contex) => DokuzSoruDetayPage(
                                jsonName: "edebiyat",
