...
class DokuzSoruDetayPage extends StatefulWidget {
  ...
  @override
  _DokuzSoruDetayPageState createState() => _DokuzSoruDetayPageState();
}

class _DokuzSoruDetayPageState extends State<DokuzSoruDetayPage> {
