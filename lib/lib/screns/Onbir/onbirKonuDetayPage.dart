...
class OnbirKonuDetayPage extends StatefulWidget {
  final String jsonName;

  const OnbirKonuDetayPage({Key key, this.jsonName}) : super(key: key);

  @override
  _OnbirKonuDetayPageState createState() => _OnbirKonuDetayPageState();
}

class _OnbirKonuDetayPageState extends State<OnbirKonuDetayPage> {
  List konu;
      ...
      body: Center(
        child: FutureBuilder(
            future: DefaultAssetBundle.of(context)
                .loadString("assets/onbir/${widget.jsonName}.json"),
