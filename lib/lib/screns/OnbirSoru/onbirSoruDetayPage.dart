...
class OnbirSoruDetayPage extends StatefulWidget {
  ...
  @override
  _OnbirSoruDetayPageState createState() => _OnbirSoruDetayPageState();
}

class _OnbirSoruDetayPageState extends State<OnbirSoruDetayPage> {
