...
class OnikiSoruDetayPage extends StatefulWidget {
  ...
  @override
  _OnikiSoruDetayPageState createState() => _OnikiSoruDetayPageState();
}

class _OnikiSoruDetayPageState extends State<OnikiSoruDetayPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          Container(height: 50, child: Center(child: BannerReklam())),
    );
  }
}
