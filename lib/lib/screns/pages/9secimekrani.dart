...
class DokuzSecimEkrani extends StatefulWidget {
  _DokuzSecimEkraniState createState() => _DokuzSecimEkraniState();
}

class _DokuzSecimEkraniState extends State<DokuzSecimEkrani> {
