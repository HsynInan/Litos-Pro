...
class KazanimTestleri extends StatefulWidget {
  _KazanimTestleriState createState() => _KazanimTestleriState();
}

class _KazanimTestleriState extends State<KazanimTestleri> {
